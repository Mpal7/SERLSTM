...
stdoutpath_featureanalysis =r'C:\Users\mp95\PycharmProjects\Thesis\logs\no_it_10k\selected_feature_analysis\LSTM256_128_dense64_mfccdeltasformantsintensitypitch.txt'
...
#"mfcc","lpcc","deltas","formants","pitch","intensity"
...
def lstm():
    ...
    for i in range(0,routine_it):
        ...
        print(
                "######### MEAN ACCURACY OVER THE " + str(splits) + " FOLDERS: " + str(np.mean(acc)) + "  ###########")
        print(
